...
public class GetWeatherInfoTask extends AsyncTask<String, Void, List<Map<String, Object>>> {
    ...
    private static String key = "&key=f32cc25d05b03d69ce016c29260b9538";
    ...
    protected void onPostExecute(List<Map<String, Object>> maps) {
        ...
        if (maps.size() > 0) {
            ...
            SimpleAdapter simpleAdapter = new SimpleAdapter(context, maps, R.layout.weather_item,
                    new String[]{"temperature", "weather", "date", "week", "weather_icon"}, new
                    int[]{R.id.temperature, R.id.weather, R.id.date, R.id.week, R.id.weather_icon});
