...
public class MainActivity extends AppCompatActivity {
    ...
    private void initChooseDialog() {
        choose_dialog = new AlertDialog.Builder(seft).setTitle("选择城市").setPositiveButton("确定",
                new ChooseCityListenner()).setNegativeButton("取消", null).create();
        ...
        ArrayAdapter<String> provinceAdapter = new ArrayAdapter<String>(this, R.layout
                .simple_list_item, new ArrayList<String>(cityMap.keySet()));
        ...
        province_spinner.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ArrayAdapter<String> cityAdapter = new ArrayAdapter<String>(seft, R.layout
                        .simple_list_item, cityMap.get(province_name));
    ...
    //f32cc25d05b03d69ce016c29260b9538
}
